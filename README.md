 ...
 * However, for the program to work, you must make sure you have ollama installed and running the model Llama 3.2 on your device as well as the streamlit, ollama and scikit-learn python libraries installed. If the program does not work on your device, check to make sure you have ollama installed and running as well as the necessary external libraries for the program 
